...
def main():
    ...
    parser.add_argument('-o1', '--output1', required=True, help='Path to output file with questions')
    parser.add_argument('-o2', '--output2', required=True, help='Path to output file with answers')
    ...
    with open(args.output1, 'w', encoding='iso-8859-1') as question_file, open(args.output2, 'w', encoding='iso-8859-1') as answer_file:
        first = True
        for pair in extractSentencePairs(conversations):
            if first:
                ...
                question_file.write('\n')
                answer_file.write('\n')
            question_file.write(pair[0])
            answer_file.write(pair[1])
